...
function init (options) {
  ...
  this._kubernetes = new Kubernetes(Object.assign(this.options, {
    ...
    onError: error =>
      debug(`[Error] kubernetes Error: ${JSON.stringify(error)}!`) ||
...
module.exports = {
  ...
  getNodes () {
    return this._kubernetes && this._kubernetes.getNodes() || {};
  },
  ...
  **/
  emit (event, args) {
    for (const handler of (this._handlers[event] || []).concat(this._handlersOnce[event])) {
